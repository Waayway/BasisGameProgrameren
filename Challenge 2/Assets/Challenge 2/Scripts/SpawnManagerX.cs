...
public class SpawnManagerX : MonoBehaviour
{
    ...
    private float spawnIntervalRangeLow = 3.0f;
    private float spawnIntervalRangeHigh = 5.0f;
    ...
    void SpawnRandomBall () {
        ...
        float delay = Random.Range(spawnIntervalRangeLow, spawnIntervalRangeHigh);
